...
//   final bool isAvailable; // true untuk tersedia, false untuk habis
...
//   void initState() {
//     super.initState();
//     searchResult = context.read<KatalogMenuProvider>().data;
//   }
...
//         searchResult = _filterMenu('', provider.data); // Reset searchResult
//         return Scaffold(
...
//                     onChanged: (value) {
//                       setState(() {
//                         searchResult = _filterMenu(value, provider.data);
//                       });
//                     },
//                     tittle: "Cari menu . . .",
//                   ),
...
//                         ...searchResult
//                             .where((item) =>
//                                 item.isReady == (widget.isAvailable ? 1 : 0))
