...
import 'package:testgetdata/data/remote/add_menu_kelola.dart';
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            ...
                            if (namaMenuController.text.isEmpty &&
                                hargaMenuController.text.isEmpty &&
                                selectedCategory == null) {
                              message =
                                  "Nama, harga, dan kategori menu belum diisi.";
                            } else if (namaMenuController.text.isEmpty) {
