...
class _CartPageState extends State<CartPage> {
  ...
  void _showConfirmOrderBottomSheet(
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        ...
        return SafeArea(
          key: Key('bottomSheetConfirmation'),
          child: WillPopScope(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Expanded(
                                  child: PrimaryButton(
                                    key: const Key('cancelOrderButton'),
                                    isEnabled: !isLoading,
          ...
          child: Container(
            child: Consumer2<CartProvider, KasirProvider>(
              builder: (context, cartProvider, kasirProvider, _) {
                // Kalau nggak ada tenant yang dipilih, berarti cuma satu tenant aktif
                              ...
                              if (isMultiTenant) {
                                ...
                                return ListView.separated(
                                  ...
                                  itemBuilder: (context, index) {
                                    final tenantCart =
                                        cartProvider.selectedCartTenant[index];
                                    final menuList =
                                        tenantCart.cartMenuList ?? [];
                        ...
                        if (cartProvider.selectedDeliveryOption == 1) ...[
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Semantics(
                                  label: 'Opsi Pengantaran Express',
                                  button: true,
                                  child: GestureDetector(
                                    key: const Key('Opsi Pengantaran Express'),
                                    onTap: () {
                                              ...
                                              children: [
                                                Text(
                                                  cartProvider.roomId == null
                                                      ? '-'
                                                      : '${_roomList.firstWhere((element) => element.id == cartProvider.roomId).gedung.ongkir + 3000 + (cartProvider.totalItemCountSelected > 10 ? (cartProvider.totalItemCountSelected - 10) * 500 : 0) + (cartProvider.selectedCartTenant.length >= 2 ? (_roomList.firstWhere((element) => element.id == cartProvider.roomId).gedung.ongkirMultitenant + 1000) : 0)}',
                                                  style: GoogleFonts.poppins(
                                                      color:
  ...
  Widget _buildCartItem(
      BuildContext context, CartMenuModel item, CartProvider cartProvider) {
    ...
    return Row(
      ...
      children: [
        ClipRRect(
          borderRadius: BorderRadius.circular(16),
          child: ImageByUrl(
            key: Key('${item.menuId}-${item.menuNama}'),
            url: item.menuGambar,
            width: 80,
            height: 80,
            fit: BoxFit.cover,
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Text(
                capitalizeFirstLetter(item.menuNama),
        ...
        Expanded(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                mainAxisSize: MainAxisSize.min, // biar pas dengan isi
                children: [
                  // Tombol -
                  Semantics(
                    label: 'Kurang Menu',
                    button: true,
                    child: GestureDetector(
                      key: Key('Kurang Menu ${item.menuId}'),
                  ...
                  Container(
                    ...
                    // ),
                    child: TextFormField(
                      key: Key('counter${item.menuId}-${item.count}'),
                  ...
                  // Tombol +
                  Semantics(
                    label: 'Tambah ${item.menuNama}',
                    button: true,
                    child: GestureDetector(
                      key: Key('tambahItem${item.menuId}'),
          ...
          Row(
            ...
            children: [
              ...
              Semantics(
                ...
                button: true,
                child: GestureDetector(
                  key: Key('Hapus Tenant ${tenant.tenantName}'),
                  onTap: () =>
