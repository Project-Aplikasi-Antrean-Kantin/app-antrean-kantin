                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          mainAxisAlignment:
                              cartProvider.tenantCarts.length >= 1
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Semantics(
                                                label:
                                                    'More Detail ${cartPerTenant.tenantName}',
                                                button: true,
                                                child: GestureDetector(
                                                  key: Key(
                                                      "${cartPerTenant.tenantName}MoreDetail"),
                                                  onTap: () async {
                                                    if (tenant.isOnline ==
                                                        false) {
                                                      Fluttertoast.showToast(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    GestureDetector(
                                                                      onTap:
                                                                        ...
                                                                        Navigator.push(
                                                                            context,
                                                                            CustomPageBuilder(page: DetailFoodPage(cartItem: item, addNewItem: false, catatan: item.catatan, tenant: tenant)));
                                                                      },
                                                                      child:
                                                                          Container(
                                                            ...
                                                            Container(
                                                                ...
                                                                child: Row(
                                                                  children: [
                                                                    ...
                                                                    SizedBox(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          key: Key(
                                                                              "${item.menuId}${item.count}Counter"),
                                                                          initialValue: item
                                                                              .count
                                                                              .toString(),
                                                                          keyboardType:
                                                                    ...
                                                                    Semantics(
                                                                      label:
                                                                          "Tambah ${item.menuNama} ke keranjang",
                                                                      button:
                                                                          true,
                                                                      child:
                                                                          GestureDetector(
