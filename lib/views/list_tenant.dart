                                    ...
                                    child: Row(
                                      children: [
                                        IconButton(onPressed: (){
                                          Provider.of<CartProvider>(context, listen: false).addRemove(dataFoods['id'], false);
                                        ...
                                        IconButton(onPressed: (){
                                          Provider.of<CartProvider>(context, listen: false).addRemove(dataFoods['id'], true);
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text("RP 22.000", style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                                color: Colors.white
                            ),),
